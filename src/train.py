...
from utils import load_data, load_data_split
import torch
...
def train(hidden_dims=[32, 32], lr=1e-3, epochs=25):
	model = model_factory['mlp'](61, 2, hidden_dims).to(device)
